...
const ProfileScreen = () => {
  ...
  const { joinedActivities, toggleJoinActivity, isActivityJoined } = useActivityContext();
  ...
  const renderActivity = ({ item }: { item: any }) => {
    ...
    return (
      ...
      >
        ...
        <Text style={styles.cardInfo}>Participants: {item.joinedCount} / {item.maxParticipants}</Text>
  ...
  const sortedActivities = joinedActivities.slice().sort((a, b) => 
